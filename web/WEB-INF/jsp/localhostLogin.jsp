...
<body>
    ...
    <div class="container">
        <div class="row">
           ...
           <h2 class="text-center title-page blue">aaa-Become Our Partner</h2>
                <section class="section">
                    <div class="login-wrap">
                        ...
                        <div class="login-container">
                            <p class="nomargin text-left blue"><a href="localhostSignup!load">Sign Up</a></p>
                        </div>
                    </div>

                    <div class="login-wrap login-wrap-collapse">
                        <div id="fbLogin" class="login-container">
                    ...
                    <form id="localhost_login_form" target="_self" method="post">
                        <div class="form-validator form-group">
                            <input type="email" class="form-control input-lg gray" id="loginId" name="loginId" placeholder="Email">
                        </div>
                        <div class="form-validator form-group">
                        ...
                        <div class="form-group text-right">
                            <a href="localhostForgetPassword!load">Forgot password?</a>
                        </div>

                        <button id="localhost_login" type="submit" class="btn btn-kootour-bold fullwidth">Log me In</button>

                    </form>

                    <br/>

                    <p class="text-center">Don't have an account? <a href="localhostSignup!load"><b>Sign Up</b></a></p>
                </section>
            </div>
        </div>
    </div>
    ...
    <footer>
		...
		<script src="/js/localhostLogin.js"></script>
</body>
</html>
