                                        ...
                                        <form class="form-horizontal" id="course_form" method="post">
                                            ...
                                            <div class="step-content pos-rel">
                                                ...
                                                <div class="step-pane" data-step="1">
                                                    <h4 class="lighter block kootour-main-color">1.Name of your
                                                        Tour</h4>
                                                    <div class="form-validator">
                                                        <div class="clearfix"><input id="fullName" type="text"
                                                                                     name="fullName"
                                                                                     class="form-control"
                                                                                     name="fullName"/></div>
                                                    </div>
                                                    <hr>
                                                    <h4 class="lighter block kootour-main-color">2.Type of your
                                                        Tour</h4>
                                                    <div class="control-group form-validator">
                                                        <div class="row">
                                                            <div class="checkbox col-xs-4">
                                                                <label>
                                                                    <input type="checkbox" class="ace" name="tourType"
                                                                           id="historical">
                                                    ...
                                                    <hr>
                                                    <h4 class="lighter block kootour-main-color">3.Languages you can
                                                        provide</h4>
                                                    <div class="form-validator">
                                                        <div class="clearfix">
                                                            <select multiple="" class="chosen-select form-control"
                                                                    id="provideLanguages"
                                                                    data-placeholder="Choose one or more Languages..."
                                                                    name="useLangId">
                                                ...
                                                <div class="step-pane" data-step="2">
                                                    <h4 class="lighter block kootour-main-color">4.Overview of your
                                                        tour</h4>
                                                    <div id="editor1"></div>
                                                    <div class="form-validator">
                                                        <div class="clearfix"><input type="text" id="overview"
                                                                                     name="overview"
                                                    ...
                                                    <div id="editor2"></div>
                                                    <div class="form-validator">
                                                        <div class="clearfix"><input type="text" id="itinerary"
                                                                                     name="itinerary"
                                                                                     style="display:none"></div>
                                                    </div>
                                                    <hr>
                                                    <h4 class="lighter block kootour-main-color">6.Important
                                                        information</h4>
                                                    <h5 class="block">Duration of the tour:</h5>
                                                    <div class="form-validator">
                                                        <div class="clearfix">
                                                            <input type="number" id="duration" name="duration"/>
                                                            <select style="height: 100%" id="durationunit-select"
                                                                    name="durationUnit">
                                                    ...
                                                    <div class="form-validator">
                                                        <div class="clearfix">
                                                            <%-- <input class="form-control" type="text" placeholder="e.g. Vancouver Downtown" id="tourLocation" name="tourLocation"/> --%>
                                                            <select style="height: 100%" id="tourLocation"
                                                                    name="tourLocation">
                                                                <s:iterator var="locationList"
                                                                            value="#request.locationMstList"
                                                                            status="status">
                                                                    <option value="<s:property value="#locationList.cityName" />">
                                                                        <s:property
                                                                                value="#locationList.cityName"/></option>
                                                                </s:iterator>
                                                    ...
                                                    <div class="form-validator">
                                                        <div class="clearfix">
                                                            <input class="form-control" type="text"
                                                                   placeholder="e.g. Will pick up at traveller's hotel"
                                                                   id="meetupLocation" name="meetupLocation"/>
                                                        </div>
                                                    </div>
                                                    <div class="hr hr-8 hr-dotted"></div>
                                                    <h5 class="block">Inclusions:
                                                        <button id="add_in" type="button"
                                                                class="btn btn-white disabled pull-right"><i
                                                    ...
                                                    <div class="hr hr-8 hr-dotted"></div>
                                                    <h5 class="block">Exclusions:
                                                        <button id="add_ex" type="button"
                                                                class="btn btn-white disabled pull-right"><i
                                                                class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add
                                                            More Exclusions
                                                        </button>
                                                ...
                                                <div class="step-pane" data-step="3">
                                                    ...
                                                    <div class="form-validator">
                                                        <div class="clearfix">
                                                            <input disabled="disabled" type="number" id="minTouristNum"
                                                                   name="minTouristNum">
                                                        </div>
                                                    </div>
                                                    <div class="hr hr-8 hr-dotted"></div>
                                                    ...
                                                    <div class="form-validator">
                                                        <div class="clearfix">
                                                            <input disabled="disabled" type="number" id="maxTouristNum"
                                                                   name="maxTouristNum">
                                                        </div>
                                                    </div>
                                                    <div class="hr hr-8 hr-dotted"></div>
                                                    ...
                                                    <div class="form-validator">
                                                        <div class="clearfix"><input disabled="disabled" type="number"
                                                                                     id="minHourAdvance"
                                                                                     name="minHourAdvance">&nbsp;hours
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="step-pane" data-step="4">
                                                    <h4 class="lighter block kootour-main-color">8.Add Your serving
                                                        schedule Option:</h4>
                                                    <h5 class="block">Schedule Name:</h5>
                                                    <div class="form-validator">
                                                        <div class="clearfix"><input disabled="disabled"
                                                                                     class="form-control" type="text"
                                                                                     placeholder="e.g.  Summer Morning Schedule"
                                                                                     id="courseScheduleName"
                                                                                     name="courseScheduleName"></div>
                                                    </div>
                                                    <div class="hr hr-8 hr-dotted"></div>
													...
													<i class="fa fa-clock-o"></i>
                                                                ...
                                                                <input disabled="disabled" type="text" id="daterange"
                                                                       name="daterange">
                                                                <input type="text" style="display:none;" id="bgnDate"
                                                                       name="bgnDate">
                                                                <input type="text" style="display:none;" id="endDate"
                                                                       name="endDate">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-validator">
                                                        <div class="clearfix">
                                                            <div id="availabledays" class="control-group">
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input disabled="disabled" sort="1"
                                                                               type="checkbox" class="ace"
                                                                               name="workDay" value="0">
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input disabled="disabled" sort="2"
                                                                               type="checkbox" class="ace"
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input disabled="disabled" sort="3"
                                                                               type="checkbox" class="ace"
                                                                               name="workDay" value="2">
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input disabled="disabled" sort="4"
                                                                               type="checkbox" class="ace"
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input disabled="disabled" sort="5"
                                                                               type="checkbox" class="ace"
                                                                               name="workDay" value="4">
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input disabled="disabled" sort="6"
                                                                               type="checkbox" class="ace"
                                                                               name="workDay" value="5">
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input disabled="disabled" sort="7"
                                                                               type="checkbox" class="ace"
                                                                               name="workDay" value="6">
                                                    ...
                                                    <div class="hr hr-8 hr-dotted"></div>
                                                    <h5 class="block">Extra value of this schedule:
                                                        <!-- <button id="add_extra" type="button" class="btn btn-white kootour-btn-main pull-right"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;Add More</button> --></h5>
                                                    <table id="extra-table"
                                                        ...
                                                        <tr data-extra="true">
                                                            <td><input disabled="disabled" class="form-control"
                                                                       type="text" placeholder="e.g. Snorking"
                                                                       name="extraNames"></td>
                                                            <td class="form-validator"><input disabled="disabled"
                                                                                              class="form-control"
                                                                                              type="text"
                                                                                              placeholder="20"
                                                                                              name="extraPrices"></td>
                                                    ...
                                                    <div id="discount">
                                                        ...
                                                        <div class="form-validator">
                                                            <div class="clearfix">
                                                                <span>If >= </span>
                                                                <input disabled="disabled" style="margin-left:10px;"
                                                                       type="number" id="discountTourists"
                                                                       name="discountTourists">
                                                                ...
                                                                <span>or</span>
                                                                <input disabled="disabled" style="margin-left:10px;"
                                                                       type="number" id="discountPercent"
													...
													<i class="fa fa-clock-o"></i>
                                                                    ...
                                                                    <input disabled="disabled" id="earliestStartHour0"
                                                                           class="time start" type="text"
                                                                           name="earliestStartHours"> to
                                                                    <input disabled="disabled" id="lastestStartHour0"
                                                                           class="time end" type="text"
                                                                           name="lastestStartHours">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="hr hr-8 hr-dotted"></div>
                                                        ...
                                                        <div class="form-validator">
                                                            <div class="clearfix">
                                                                <input disabled="disabled" type="number"
                                                                       id="retailprice0" name="retailPrices">
                                                            </div>
                                                        </div>
                                                        <div class="hr hr-8 hr-dotted"></div>
                                                ...
                                                <div class="step-pane" data-step="5">
                                                    ...
                                                    <h4 class="lighter block kootour-main-color">9. Have been uploaded
                                                        images:</h4>
                                                    ...
                                                    <h4 class="lighter block kootour-main-color">10. Upload
                                                        Pictures:</h4>
                                                    <h5 class="block">Upload up to five color photos that represent your
                                                        tour or activity. </h5>
                                                ...
                                                <div class="step-pane" data-step="6">
                                                    ...
                                                    <div class="row">
                                                        <div class="left-column col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                                            <section id="prev-carousel-kootour-section"
                                                                     class="carousel-kootour carousel-kootour-section nopadding col-xs-12">
                                                            </section>

                                                            <section
                                                                    class="tour-detail section noborder nomargin col-xs-12">
                                                                <div class="tour-descriptions">
                                                                    <table class="tour-description">
                                                                        <tr>
                                                                            <td>
                                                                                <img class="icon"
                                                                                     src="/images/icons/icon_time_bgwhite_300X300.png"
                                                                                     alt="time">
                                                                            </td>

                                                                            <td>
                                                                                <s:label id="prevDuration2"/> <s:label
                                                                                    id="prevDurationUnit2"/>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <table class="tour-description">
                                                                        <tr>
                                                                            <td>
                                                                                <img class="icon"
                                                                                     src="/images/icons/icon_luggage_bgwhite_300X300.png"
                                                                                     alt="luggage">
                                                                            </td>

                                                                            <td>
                                                                                <s:label
                                                                                        id="prevMinTouristNum"/>-<s:label
                                                                                    id="prevMaxTouristNum"/> travellers
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                    <table class="tour-description">
                                                                        <tr>
                                                                            <td>
                                                                                <img class="icon"
                                                                                     src="/images/icons/icon_location_bgwhite_300X300.png"
                                                                                     alt="location">
                                                                            </td>
                                                                    ...
                                                                    <table class="tour-description">
                                                                        <tr>
                                                                            <td>
                                                                                <img class="icon"
                                                                                     src="/images/icons/icon_language_bgwhite_300X300.png"
                                                                                     alt="language">
                                                                            </td>
                                                                ...
                                                                <h2 class="blue" id="prevFullName">&nbsp;
                                                                    <small>($<s:label id="prevRetailPrice"/> per
                                                                        person/group)
                                                                    </small>
                                                                </h2>
                                                            ...
                                                            <section class="section col-xs-12">
                                                                ...
                                                                <div id="readmore1">
                                                                    <p id="prevCourseContent"
                                                                       style="width: 100%;word-wrap:break-word;word-break:break-word;"></p>

                                                                    <span class="subtitle">Tour itinerary</span>

                                                                    <p id="prevAdditionalInfo"
                                                                       style="width: 100%;word-wrap:break-word;word-break:break-word;"></p>
                                                        ...
                                                        <div class="right-column col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                            <section class="widget nopadding section section-small">
                                                                <form action="booking.html" class="form-horizontal">
                                                                    ...
                                                                    <div id="prevCustomized"
                                                                         class="widget-row customized-option">
                                                                    </div>
