...
<head>
		...
		<meta charset="utf-8">
		<title>Exclusive Date | Kootour</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="localhostExclusiveDate!load">Exclusive Date</a>
							</li>
						</ul>
					</div>
							...
							<div class="widget-box kootour-widget-color-main light-border">
								<div class="widget-header">
									<h4 class="widget-title lighter">
										<span class="white">Calendar:</span>
									</h4>
								</div>
...
<jsp:include page="localhostFooter.jsp" />
		...
		<script src="js/localhostExclusiveDate.js" type="text/javascript"></script>
