...
<head>
		...
		<meta charset="utf-8">
		<title>Bank Information | Kootour</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="localhostBankInformation!load">Bank Information</a>
							</li>
						</ul>
					</div>
					...
					<form id="localhost_bank_form" class="form-horizontal" role="form">
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="widget-box kootour-widget-color-main light-border">
								<div class="widget-header">
									<h4 class="widget-title lighter">
										<span class="pull-left white">Bank Information:</span>
									</h4>
								</div>
								<div class="widget-body kootour-widget-color-main">
									<div class="widget-main">
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 col-md-3 col-lg-3 control-label align-left"> <b>Bank Name</b></label>
												<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
													<input type="text" id="bankName" name="bankName" class="form-control">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 col-md-3 col-lg-3 control-label align-left"> <b>Bank Branch</b></label>
												<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
													<input type="text" id="bankBranch" name="bankBranch" class="form-control">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 col-md-3 col-lg-3 control-label align-left"> <b>Bank account No</b></label>
												<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
													<input type="text" id="bankAccountNo" name="bankAccountNo" class="form-control">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 col-md-3 col-lg-3 control-label align-left"> <b>Bank account type</b></label>
												<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
													<input type="text" id="bankAccountType" name="bankAccountType" class="form-control">
												</div>
											</div>
											<div class="form-group">
												<label class="col-xs-12 col-sm-12 col-md-3 col-lg-3 control-label align-left"> <b>Bank account owner</b></label>
												<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
													<input type="text" id="bankAccountOwner" name="bankAccountOwner" class="form-control">
												</div>
											</div>
										</div>
								</div>
					...
					<button type="submit" class="btn btn-white kootour-btn-main pull-right">Update</button>
					</form>
					</div><!-- /.page-content -->
				</div>
			</div><!-- /.main-content -->
...
<jsp:include page="localhostFooter.jsp" />
		...
		<script src="js/localhostBank.js" type="text/javascript"></script>
